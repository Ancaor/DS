...
import Interfaz.ControlMouseAdapter;
import Interfaz.ControlMouseMotionAdapter;
...
extends JPanel {
    ...
    private Control controlAutomatico;
    private Freno freno;

    public PanelControlAutomatico(Vehiculo vehiculo, Control controlAutomatico, Freno freno) {
    ...
    public void paintComponent(Graphics g) {
        ...
        if (this.vehiculo.getEstadoMotor() == 1) {
            g2.drawString(this.tablaEstado[this.estado.ordinal()], 24, 35);
